...
Версия FreePBX определяется отдельно от версии Node.js: PBXPuls устанавливается как на FreePBX 16, так и на FreePBX 17. Установщик не заменяет рабочий Node.js и не вмешивается в системные пакеты FreePBX. На Node.js 18 доступны основные функции PBXPuls; интеграция Google GenAI требует Node.js 20 или новее.
