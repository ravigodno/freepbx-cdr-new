...
function fail(path: string): never { throw new ToolExecutionError('internal_error', 500, `Invalid tool output at ${path}`); }
...
export function validateToolOutput(schema: any, value: any): any { validate(schema, value, '$'); return value; }
