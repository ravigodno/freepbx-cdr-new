...
export interface RealtimeVoiceConfig { providerKey:string;apiKey?:string;url?:string;model?:string;voice?:string;language:string;instructions:string;maxOutputTokens?:number;retryOutputTokens?:number;greetingOutputTokens?:number;inputFormat:AudioFormat;outputFormat:AudioFormat;serverVad:boolean;semanticVad?:boolean;responseEagerness?:'low'|'medium'|'high';endOfTurnSilenceMs?:number;tools:PublicRealtimeToolDefinition[];timeoutMs:number }
