...
import { isPermissionModuleVisible, type PermissionKey } from '../../../shared/accessCatalog';
export type { PermissionKey } from '../../../shared/accessCatalog';
...
function isPermissionAllowedByModuleVisibility(session:PermissionSession,settings:Partial<AppSettings>|null|undefined,perm:PermissionKey):boolean {
  return isPermissionModuleVisible(session.role,settings?.moduleVisibility,perm);
}
