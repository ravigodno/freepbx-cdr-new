...
export const MANAGEMENT_SECTIONS: ManagementSection[] = [
  ...
  { id: 'operator-templates', label: ui.management.operatorTemplates, description: ui.management.sections.operatorTemplatesDescription, status: 'planned', roadmap: ui.management.sections.roadmapOperatorTemplates, icon: Settings },
