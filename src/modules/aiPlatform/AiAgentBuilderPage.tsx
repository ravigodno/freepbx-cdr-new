...
interface Props { token:string; canCreate:boolean;canViewKnowledge:boolean;canViewTraining:boolean;canViewTransfers:boolean;canTestTransfer:boolean }
...
export default function AiAgentBuilderPage({token,canCreate,canViewKnowledge,canViewTraining,canViewTransfers,canTestTransfer}:Props){
