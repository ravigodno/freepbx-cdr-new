...
export interface CallEntry {
  ...
  logicalCall?: boolean;
  logicalStatus?: 'human_handoff_answered' | 'human_handoff_no_answer' | 'human_handoff_busy' | 'human_handoff_failed' | 'human_handoff_declined' | 'human_handoff_returned_to_ai';
  ...
  aiPhaseDuration?: number;
  aiTalkDuration?: number;
  transferSetupDuration?: number;
  humanRingDuration?: number;
  humanTalkDuration?: number;
  totalLogicalDuration?: number;
  technicalLegsCount?: number;
